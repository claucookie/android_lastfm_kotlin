object Config {
    object BuildPlugins {
        val androidApplicationPlugin = "com.android.application"
        val androidLibraryPlugin = "com.android.library"
        val androidPlugin = "android"
        val kaptPlugin = "kapt"
        val extensionsPlugin = "android.extensions"
    }
    ...
    sealed class DepConfig(open var nameAndVersion: String) {
        ...
        data class DepAndroidTestImpl(override var nameAndVersion: String) :
            DepConfig(nameAndVersion)
    }
